...
class BasesControllerTest < ActionController::TestCase
  ...
  test "should create basis" do
    assert_difference('Base.count') do
      post :create, basis: { date: @basis.date, examples: @basis.examples, id: @basis.id, instructions: @basis.instructions, knowledge: @basis.knowledge, name: @basis.name, tags: @basis.tags }
    end
  ...
  test "should update basis" do
    patch :update, id: @basis, basis: { date: @basis.date, examples: @basis.examples, id: @basis.id, instructions: @basis.instructions, knowledge: @basis.knowledge, name: @basis.name, tags: @basis.tags }
    assert_redirected_to basis_path(assigns(:basis))
  end
